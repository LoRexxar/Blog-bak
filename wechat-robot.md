...
如果你尝试使用中间人的方案去爬微信公众号的文章，那么你会在**触发反爬规则之后被阻止访问触发规则的页面**（我猜测是这样，我被封了3个号都没找到被封的具体原因），这样的话可以最小限度的避免对普通用户的影响，毕竟普通用户刷微信公众号的频率也很高。**但事实则是，由于我们无法访问历史文章列表，即便我们还可以读取文章内容，但也无法实现自动更新了。**
