...
知乎是第一个拉黑的，其经历比较魔幻，一面是一个非常资深的开发，其开发能力碾压5个我可能都不过分，面试的过程中，我必须承认我的开发基础并不过关，但面试官也表示了强烈的碾压我的范，一面就给我留下了很不好的印象。（从这次经历我也意识到，如果面试别人的时候能感觉别人不会的话，应该及时转移，也避免面试者的逆反心理），在一面之后说实话我就很不认可知乎的文化了，但是HR坚持要二面，于是二面的是一个很明显的安全，在聊天过程中非常愉快，我也及时调整了心态。但可惜的是，有可能是因为知乎上市，也有可能是和我对接的HR离职了，反正就是突然失去联系了，知乎的面试到这里就告一段落了。
